    ...
    <section id="contact" className="contact py-48">
      ...
      <div className="md:flex md:justify-between gap-16 mt-5">
        ...
        >
          ...
          >
            <input
              className="w-full bg-blue font-semibold placeholder-opaque-black p-3 text-xl"
              type="text"
              placeholder="NAME"
              {...register("name", {
                required: true,
            ...
            <input
              className="w-full bg-blue font-semibold placeholder-opaque-black p-3 mt-5 text-xl"
              type="text"
              placeholder="EMAIL"
              {...register("email", {
                required: true,
